...
public class RegexTestingUtils {
  ...
  public static void testSubstringToPropertyExtraction(String inputString, Stream<String> expectedStrings,
                                                       ProcessorDescriptor descriptor, String propertyKey) {
    TestItem testItem = new TestItem();
    TestStringContent content = testItem.createContent(TestStringContent.class)
        .withData(inputString)
        .save();
    ...
    Iterator<String> actual = content.getAnnotations().getAll()
    ...
    assertTrue(!actual.hasNext() && !expected.hasNext(), "Number of expected strings does not match actual string count");
  }
}
