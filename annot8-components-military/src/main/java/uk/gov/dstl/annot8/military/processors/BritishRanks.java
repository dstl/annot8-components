...
public class BritishRanks
  extends AbstractProcessorDescriptor<BritishRanks.Processor, NoSettings> {
  ...
  public static class Processor extends AbstractRegexProcessor {
    public Processor() {
      super(
        Pattern.compile("\\b(?<rank>(Flt Lt|Lt Gen|Lt Col|Air Cdre|Gp Capt|Wg Cdr|Sqn Sgt Maj|" +
